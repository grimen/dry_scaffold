...
Install dependencies to release the full power of dry_scaffold.
...
h5. Config (in _environment.rb_/_development.rb_)
...
<pre>config.gem 'justinfrench-formtastic', :lib => 'formtastic'</pre>
...
<pre>config.gem 'josevalim-inherited_resources', :lib => 'inherited_resources'</pre>
