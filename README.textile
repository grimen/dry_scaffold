...
Usage: <pre>_actions:new,create,quack,index,...</pre>
...
<pre>_actions:quack</pre> => <pre>quack</pre>
<pre>_actions:*,quack</pre> => <pre>show,index,new,edit,create,update,destroy,quack</pre>
...
<pre>_formats:iphone</pre> => <pre>txt</pre>
<pre>_formats:*,txt</pre> => <pre>html,js,xml,json,iphone</pre>
