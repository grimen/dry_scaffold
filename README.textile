...
Find out more about WillPaginate: http://github.com/mislav/will_paginate
...
You can override what actions that should be generated directly in the generator arguments - including custom actions.
...
* *include-layout*    - Generate application layout.
